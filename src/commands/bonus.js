...
module.exports = {
    ...
    async bonus_guide(msg) {
        let embed = new EmbedBuilder()
            ...
            .addFields({ name: '1. **+stimulus**', value: `Earn **${comma_adder.add(Math.trunc(stimulus_payout))}** credits instantly.`, inline: false })
            .addFields({ name: '2. **+raise**', value: `Increase your hourly **+income** by **${comma_adder.add(Math.trunc(raise_payout))}** credits for the rest of the month.`, inline: false })
